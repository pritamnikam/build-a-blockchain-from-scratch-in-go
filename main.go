...
// main is the entry point for this simple demo application.
// It initializes a blockchain, appends a few blocks and prints
// each block's previous hash, data and computed hash.
func main() {
